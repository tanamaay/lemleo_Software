            ...
            <div className="relative mt-[-38px] h-[600px] self-stretch">
              <div className="absolute bottom-0.5 left-0 right-0 m-auto h-[460px] flex-1 rounded-[52px] bg-blue-900">
                ...
                <div className="absolute bottom-0 right-[7%] top-0 my-auto flex h-max w-[48%] flex-col items-start gap-8">
                  <div className="flex flex-col gap-[22px] self-stretch">
                    ...
                    <div className="flex flex-col gap-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <Heading
                          as="h4"
                          className="text-[30px] font-semibold text-white-a700 md:text-[28px] sm:text-[26px]"
                        >
                          +91-8873-33-8873
                        </Heading>
                      </div>
                  ...
                  <Button className="flex h-[54px] min-w-[136px] flex-row items-center justify-center rounded-[10px] bg-white-a700 px-6 text-center text-[18px] font-semibold text-blue-900_02 sm:px-5">
                    Contact Us
                  </Button>
                </div>
              </div>
