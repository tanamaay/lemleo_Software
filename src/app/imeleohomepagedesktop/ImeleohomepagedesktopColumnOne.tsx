    ...
    <div className="mt-[60px] flex flex-col items-center">
      <div className="container-xs flex flex-col items-center gap-12 md:px-5">
        <div className="flex w-[46%] flex-col items-center gap-2 md:w-full">
          ...
          >
            Trusted expertise, cutting-edge technology, and a customer-first approach to drive your success.
          </Text>
        </div>
        ...
        <div className="flex justify-center mt-8">
          <Button
            ...
            className="flex h-[60px] min-w-[176px] flex-row items-center justify-center gap-2.5 rounded-lg bg-blue-900_02 px-[34px] text-center text-[16px] font-bold text-white-a700 sm:px-5 transition duration-300 ease-in-out hover:bg-blue-700 hover:shadow-lg hover:scale-105"
          >
            View More
          </Button>
        </div>
